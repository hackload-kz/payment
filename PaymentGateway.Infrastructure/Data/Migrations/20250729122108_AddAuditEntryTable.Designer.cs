...
namespace PaymentGateway.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250729122108_AddAuditEntryTable")]
            ...
            modelBuilder.Entity("PaymentGateway.Core.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("CustomerId1")
                        .HasDatabaseName("i_x_payments_customer_id1");
                    ...
                    b.HasIndex("TeamId1")
                        .HasDatabaseName("i_x_payments_team_id1");
            ...
            modelBuilder.Entity("PaymentGateway.Core.Entities.Team", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("SupportedCurrencies")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("supported_currencies");

                    b.PrimitiveCollection<int[]>("SupportedPaymentMethods")
                        .IsRequired()
                        .HasColumnType("integer[]")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 29, 12, 21, 7, 711, DateTimeKind.Utc).AddTicks(3360),
                            CreatedBy = "SYSTEM",
                            Enable3DSecure = true,
                            ...
                            ProcessingFeePercentage = 0m,
                            RequireManualReviewForHighRisk = true,
                            RowVersion = new byte[0],
                            SettlementDelayDays = 1,
                            SuccessUrl = "https://demo.example.com/success",
                            SupportedCurrencies = new List<string> { "RUB" },
                            SupportedPaymentMethods = new[] { 0 },
                            TeamName = "Demo Team",
                            TeamSlug = "demo-team",
                            TimeZone = "UTC",
                            UpdatedAt = new DateTime(2025, 7, 29, 12, 21, 7, 711, DateTimeKind.Utc).AddTicks(3450),
                            UpdatedBy = "SYSTEM",
                        ...
                        new
                        {
                            ...
                            ApiVersion = "v1",
                            BusinessInfo = new Dictionary<string, string>(),
                            CreatedAt = new DateTime(2025, 7, 29, 12, 21, 7, 711, DateTimeKind.Utc).AddTicks(3880),
                            CreatedBy = "SYSTEM",
                            Enable3DSecure = true,
                            EnableFraudDetection = true,
                            EnablePartialRefunds = false,
                            ...
                            TeamSlug = "test-team",
                            TimeZone = "UTC",
                            UpdatedAt = new DateTime(2025, 7, 29, 12, 21, 7, 711, DateTimeKind.Utc).AddTicks(3880),
                            UpdatedBy = "SYSTEM",
                            WebhookRetryAttempts = 3,
                            WebhookTimeoutSeconds = 30
                        });
            ...
            modelBuilder.Entity("PaymentGateway.Core.Entities.Transaction", b =>
                {
                    ...
                    b.Property<Guid?>("ParentTransactionId1")
                        .HasColumnType("uuid")
                        .HasColumnName("parent_transaction_id1");
            ...
            modelBuilder.Entity("PaymentGateway.Core.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("PaymentGateway.Core.Entities.Team", "Team")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_payments_teams_team_id1");
